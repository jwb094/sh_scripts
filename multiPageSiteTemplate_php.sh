...
createProjectsFiles(){
  ...
  # create new node project
  touch  work.php about.php contact.php index.php public/src/css/projectstyle.scss public/src/js/app.js public/src/css/components/_partials1.scss public/src/css/pages/_index.scss webpack.mix.js .gitignore
